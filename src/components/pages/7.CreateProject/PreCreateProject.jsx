        ...
        <>
            <div className="flex flex-row container mx-auto my-20 gap-20">
                ...
                <div className="w-1/2 gap-5">
                    ...
                    <h2 className="text-sm my-5">
                        We provide the best tools for creators to plan, draft and execute amazing crowdfunding campaigns
                        for a range of different categories and projects.
                    </h2>
            ...
            <div>
                ...
                <div className="container mx-auto my-20  flex flex-col sm:flex-row items-center justify-center">
                    ...
                    <div className="w-1/2 flex items-center justify-center">
                        <img src="https://res.cloudinary.com/thisisdupreecloud/image/upload/v1636452589/Illustration_1_rmxorr.svg" alt="showImage" />
                    </div>
                </div>
                <div className="container mx-auto my-20  flex flex-col sm:flex-row items-center justify-center">
                    <div className="w-1/2 flex items-center justify-center">
                        <img src="https://res.cloudinary.com/thisisdupreecloud/image/upload/v1636452588/Illustration_2_i1clhz.svg" alt="showImage" />
                    </div>
                    <div className="w-1/2 flex items-center justify-center">
                        <h1 className="text-xl sm:text-3xl">
                ...
                <div className="container mx-auto my-20  flex flex-col sm:flex-row items-center justify-center">
                    ...
                    <div className="w-1/2 flex items-center justify-center">
                        <img src="https://res.cloudinary.com/thisisdupreecloud/image/upload/v1636452588/Illustration_3_a6bpfr.svg" alt="showImage" />
                    </div>
                </div>
            </div>
