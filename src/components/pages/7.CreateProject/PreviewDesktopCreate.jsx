                ...
                <div className="flex w-full justify-around items-center text-white">
                    <div>
                        <h1 className="text-7xl font-bold py-2">
                            {organization || userInfo.username || "Organization"}
                        </h1>
                        ...
                        <div className="flex flex-row py-2 my-5">
                            ...
                            <button
                                className="inline-flex bg-clear mx-3 text-white rounded-full h-8 px-3 justify-center items-center hover:bg-purple-300"
                                title={about}
                            >
                                <HiOutlineShare />
