...
function EditThirdStep({facebook, instagram, twitter, website, userInfo , setShow2 , setShow3}) {
  ...
  return (
    <>
      ...
      <button className="rounded-xl text-white bg-prigreen hover:bg-green-800 w-16 h-10 text-md font-semibold mx-3" onClick={clickBack}>
        Back
      </button>
      <button className="rounded-xl text-white bg-priorange hover:bg-red-500 w-16 h-10 text-md font-semibold mx-3" onClick={clickNext}>
      Next
      </button>
    </div>
    </>
