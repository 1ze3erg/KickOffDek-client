...
import Cardpledgenobutton from "../1.Home/card/Cardpledgenobutton";
    ...
    <>
      <div className="w-3/4 ml-10 mt-12">
        <div className="flex flex-row justify-between">
          <h1 className="text-xl font-medium">Saved Projects</h1>
        </div>
      </div>
      <div className=" mx-auto mt-20 grid 2xl:grid-cols-4 lg:grid-cols-2 grid-cols-1 gap-y-16">
          ...
          <div className="text-gray-600 overflow-hidden shadow-lg transition duration-200 ease-in-out transform hover:-translate-y-1 hover:shadow-2xl rounded-lg w-72 cursor-pointer mx-3">
            <div className="w-full block h-full">
              ...
              <div className="absolute top-20 h-28 w-full bg-gradient-to-t from-gray-800 flex items-center justify-center">
                <h1 className="text-2xl text-white line-clamp-2 mx-5">
                  Deeznuts Deeznuts
                </h1>
              </div>
