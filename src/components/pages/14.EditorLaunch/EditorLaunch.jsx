...
function EditorLaunch() {
  ...
  return (
    <div className="p-10">
      <Link to={`/edit-project/${projectId}`} className="text-prigreen flex flex-row items-center gap-4">
      ...
      <h3 className="text-sm w-3/4">
        I (we) am (are) aware that it is my (our) personal responsibility to
        deliver the Rewards I (we) have promised to Supporters if my (our)
        Project is successful and to do so by the date(s) stated to Supporters
        of the Project. Failure to deliver the Rewards as stated and on time may
        leave me (us) in breach of consumer protection law and require me (us)
        to provide a full refund to my (our) Project Supporters. I (we) declare
        all information I (we) have provided is true and within the laws of my
        (our) location. Provision of information later found to be false may
        lead to the cancellation of my (our) Project on this platform. Read
        complete Terms & Conditions.
      </h3>
      <input className="mt-10" type="checkbox" />
      <span className="mx-3">
        I agree to the Terms & Conditions of running a project.
      </span>
      ...
      <div className="flex flex-col items-center justify-center w-3/4 my-20 gap-5">
        ...
        <h3 className="text-lg text-center">
          While we are preparing feedbacks, check out the rest of your
          checklists to review them.
        </h3>
      </div>
      {/*กด Submit แล้ว  */}
      <h1>กด Submit แล้ว </h1>
