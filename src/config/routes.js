...
import AdminHome from "../components/pages/16.AdminPage/AdminHome";
...
import PreCreateProject from "../components/pages/7.CreateProject/PreCreateProject";
...
const routes = {
    user: {
        route: [
            ...
            { path: "/create", component: PreCreateProject },
